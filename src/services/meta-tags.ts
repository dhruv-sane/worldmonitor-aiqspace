// Dynamic Meta Tags Service for GeoSentinel
...
const DEFAULT_IMAGE = `${location.origin}/favico/og-image.png`;
...
export function updateMetaTagsForStory(meta: StoryMeta): void {
  ...
  const title = `${countryName} Intelligence Brief | GeoSentinel`;
...
export function resetMetaTags(): void {
  const defaultTitle = 'GeoSentinel — Global Intelligence Dashboard';
...
function generateDescription(
  ...
  return `GeoSentinel ${parts.join('. ')}. AI-powered geopolitical intelligence.`;
}
