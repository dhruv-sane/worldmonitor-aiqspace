...
// Happy variant uses self-hosted warm styles; default uses CARTO dark-matter CDN
...
export class DeckGLMap {
  ...
  private setupDOM(): void {
    ...
    // Map attribution (Stadia Maps basemap + OpenMapTiles + OpenStreetMap data)
    const attribution = document.createElement('div');
    attribution.className = 'map-attribution';
    attribution.innerHTML = '© <a href="https://stadiamaps.com/" target="_blank" rel="noopener">Stadia Maps</a> © <a href="https://openmaptiles.org/" target="_blank" rel="noopener">OpenMapTiles</a> © <a href="https://www.openstreetmap.org/copyright" target="_blank" rel="noopener">OpenStreetMap</a>';
  ...
  private fetchServerBases(): void {
    ...
    fetchMilitaryBases(sw.lat, sw.lng, ne.lat, ne.lng, zoom).then((result) => {
      if (!result) return;
      console.log('[API Data] fetched Military Bases (viewport):', result);
